...
const LoginForm = () => {
  ...
  return (
    <div className="z-20 sm:w-[310px] w-[300px] ">
      ...
      <Form {...form}>
        ...
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-white/60 font-light">Email</FormLabel>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-white/60 font-light">Password</FormLabel>
      ...
      <div className="bg-gradient-to-r from-transparent via-neutral-300 dark:via-neutral-700 to-transparent my-8 h-[1px] w-full hover:bg-white" />
      {/* <Socials /> */}
    </div>
  );
};
